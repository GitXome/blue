...
fontLoader.load("/static/fonts/helvetiker_bold.typeface.json", (font) => {
  const textGeometry = new THREE.TextGeometry("THIS™", {
    font,
    size: 1,
    height: 0.2,
    curveSegments: 100,
  ...
  textGeometry.translate(-4, 0.25, 2);
  const text2Geometry = new THREE.TextGeometry("CLOTHING & ACCESSORIES", {
    font,
    size: 0.7,
    height: 0.1,
    curveSegments: 100,
  ...
  text2Geometry.translate(-3.9, -0.86, 2);
